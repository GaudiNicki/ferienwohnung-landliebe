  ...
  return (
    <section id="contact" className="p-8 lg:py-20 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-12 text-emerald-800">
          Kontakt & Buchung
        </h2>
              ...
              <div className="flex flex-col">
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="space-y-4">
                      ...
                      <p className="text-gray-600">
                        Als Ihre Gastgeber möchten wir Ihnen einen angenehmen
                        und erholsamen Aufenthalt ermöglichen. Die Ferienwohnung
                        wurde mit viel Liebe zum Detail von uns eingerichtet und
                        bietet Ihnen allen Komfort für einen entspannten
                        Aufenthalt in der malerischen Rhön. Wir stehen Ihnen bei
                        Fragen zur Umgebung oder Ausflugszielen gerne mit Rat
                        und Tat zur Seite und freuen uns, Ihnen unser schönes
                        Stückchen Heimat näherbringen zu dürfen.
                      </p>
                      ...
                      <div className="space-y-2 text-gray-600">
                        <div className="flex items-center gap-2">
                          ...
                          <a
                            href="mailto:kontakt@ferienwohnunglandliebe.de"
                ...
                <div className="flex flex-col justify-center mt-4 gap-4">
                  ...
                  <div className="mt-2 p-4 bg-emerald-50 rounded-xl">
                    <p className="text-sm">
                      Haben Sie Fragen? Kontaktieren Sie uns gerne - wir helfen
                      Ihnen bei der Planung Ihres Aufenthalts.
                    </p>
                  </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Nutzen Sie unseren Kalender, um die Verfügbarkeit Ihres
                      Wunschzeitraums zu prüfen.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Sie erhalten von uns zeitnah eine Rückmeldung mit allen
