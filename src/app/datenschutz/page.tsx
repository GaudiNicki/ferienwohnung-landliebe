            ...
            <section id="datenschutz-ueberblick">
               ...
               <section id="hosting">
                 ...
                 <p>
                   ...
                   6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die
               ...
               <section id="allgemeine-hinweise">
                 ...
                 <p className="mt-2 ml-4">
                   ...
                   <br />
                   <br />
                   E-Mail: <a className="hover:text-emerald-900 transition-colors" href="mailto:info@ferienwohnunglandliebe.de">info@ferienwohnunglandliebe.de</a>
                   <br />
                   Telefon: <a className="hover:text-emerald-900 transition-colors" href="tel:+4915756041425">+4915756041425</a>
                 </p>
                 <p className="mt-4">
               ...
               <section id="plugins-tools">
                 ...
                 <p>
                   ...
                   <a
                     ...
                     className="block text-emerald-600 hover:underline mt-1"
                   >
